...
! function(t) {
  t.MDChapter = function(e, n) {
    var padding = getComputedStyle(document.body).getPropertyValue('--padding').replace('px', '') * 2,
      o = (t.extend({}, t.fn.MDChapter.defaults, n), t(e)),
